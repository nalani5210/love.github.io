window.SINGLE_TAB = "  ";
window.ImgCollapsed = "/index/index-assets/img/Collapsed.gif";
window.ImgExpanded = "/index/index-assets/img/Expanded.gif";
...
function Process() {
    ...
    try {
        ...
        $id("Canvas").innerHTML = "<PRE class='CodeContainer'>"
            + "<img data-toggle=\"tooltip\" data-placement=\"top\"  src=\"/index/index-assets/svg/copy.svg\" id=\"copy\" alt=\"\" style='float: right;margin-left: 8px;' width=\"20\" height=\"20\" title=\"copy to Clipboard\"/>"
            + "<img src=\"/index/index-assets/svg/collapse-all.svg\" id=\"collapse-all\" alt=\"\" style='float: right;margin-left: 8px;' width=\"20\" height=\"20\" title=\"collapse nodes\" />"
            + "<img src=\"/index/index-assets/svg/expand-all.svg\" id=\"expand-all\" alt=\"\" style='float: right' width=\"20\" height=\"20\" title=\"expand nodes\" />"
            + html + "</PRE>";
    } catch (e) {
...
function ProcessObject(obj, indent, addComma, isArray, isPropertyContent) {
    ...
    if (IsArray(obj)) {
        if (obj.length == 0) {
            ...
            clpsHtml = "<span><img src=\"" + window.ImgExpanded +
                "\" onClick=\"ExpImgClicked(this)\" /></span><span class='collapsible'>";
...
$('#Canvas').on('click', '#collapse-all', function() {
    CollapseAllClicked();
});

$('#Canvas').on('click', '#expand-all', function() {
    ExpandAllClicked();
});

$('#Canvas').on('click', '#copy', function() {
    const input = document.createElement('textarea');
    document.body.appendChild(input);
    input.value = $(".CodeContainer")[0].innerText;
    input.select();
...
$('#json-forrmat-loadfile').change(function() {
...
$('#json-forrmat-file').click(function() {
    $("#json-forrmat-loadfile").click();
});
